            ...
            <div class="HomeLayout">
                ...
                <div class="MenuLayout">
                    <div class="Menu">
                        ...
                        if ($book == 1) {
                            $output = "";
                            $output .= "<img src= img/Boy_Love.png>";
                            echo $output;
                        } else {
                            $output = "";
                            $output .= "<img src= img/Fan_fiction.png>";
                            echo $output;
                        }
                        ?>
                    </div>
                    <div class="Product">
                        <div class="container-fluid">
                            <div class="row d-flex justify-content-center">
                                <?php
                                $book = $_GET['book'];
                                $sql = "select * from product where Type = '$book'";
                                $result = $conn->prepare($sql);
                                $result->execute();
                                $fetch = $result->fetchAll(PDO::FETCH_ASSOC);
                                $output = "";
                                foreach ($fetch as $row) {
                                    $output .= " <div class = " . '"col-lm-3 px-4 py-4"' . " data-toggle=modal data-target=#" . $row['Id_book'] . ">";
                                    $output .= "<img src=" . $row['Path'] . ">";
                                    $output .= "</div>";
                                }
                                echo $output;
                                ?>
                ...
                $output = "";
                foreach ($fetch as $row) {
                    $output .= " <div class=" . '"modal fade"' . " id=" . $row['Id_book'] . " tabindex=-1 role=dialog aria-labelledby=exampleModalLabel aria-hidden=true>
                       <div class=modal-dialog role=document>
                           <div class=modal-content>
                               <div class=modal-header>
                               ...
                               <img src=" . $row['Path'] . " class= " . '" w-25 py-4"' . ">
                               </div>
                               ...
                               <div class=modal-footer>
                           <button type=button class=" . '"btn btn-primary"' . ">ใส่ตะก้า</button>
                           <button type=button class=" . '"btn btn-secondary"' . " data-dismiss=modal>ปิดหน้า</button>
                       </div>
                           </div>
                       </div>
                   </div>";
